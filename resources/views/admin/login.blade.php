                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Đăng nhập vào trang quản trị!</h1>
                            </div>
                            @include('alert')
                            <form class="user" action="{{ route('check_login_admin') }}" method="post">
                                ...
                                <div style="display: flex ; justify-content: center">
                                    <button type="submit" class="btn btn-primary btn-user btn-block col-3" >
                                    Login
                                </button>
                                </div>
